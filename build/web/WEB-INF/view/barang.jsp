                                ...
                                <div class="module">
                                    ...
                                    <div class="module-body">
                                        <table class="table table-striped">
                                            <div class="pull-left">
                                                <a href="tambahbarang.htm" class="btn btn-primary">Tambah Barang</a>
                                            </div>
                                            <thead>                                          
                                                <tr>
                                                    <th>Barang</th>
                                            ...
                                            <tbody>
                                                <c:forEach items="${list}" var="b">
                                                    <tr>
                                                        <td>${b.barang}</td>
                                                        <td>${b.idKategori.kategori}</td>
                                                        <td>${b.stock}</td>
                                                        <td>${b.harga}</td>
                                                        <td>${b.status}</td>
                                                        <td>
                                                            <a href="editbarang.htm?id=${b.idBarang}" class="btn btn-warning">Ubah</a>
                                                            <a href="deletebarang.htm?id=${b.idBarang}" class="btn btn-danger">Hapus</a>
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
