                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3>Forms Tambah Kategori</h3>
                                </div>
                                <div class="module-body">
                                    <form class="form-horizontal row-fluid" action="prosestambahkategori.htm" method="POST">
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Kategori</label>
                                            <div class="controls">
                                                <input type="text" name="kategori" id="basicinput" class="span8" required>
                                            </div>
                                        </div>
                                        <div class="control-group">
                                            <div class="controls">
