            ...
            <div class="container">
                <div class="row">
                    <div class="module module-login span4 offset4">
                        <form name="form-forgot-password" class="form-vertical" method="POST" action="resetpassword.htm">
                            ...
                            <div class="module-body">
                                <div class="control-group">
                                    <div class="controls row-fluid">
                                        <input class="span12" name="username" type="text" id="inputText" placeholder="Username" required="">
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls row-fluid">
                                        <input class="span12" name="to" type="email" id="inputEmail" placeholder="E-mail" required="">
                                    </div>
                                </div>
                            </div>
