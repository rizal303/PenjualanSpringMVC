                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3>Forms Tambah Barang</h3>
                                </div>
                                <div class="module-body">
                                    <form class="form-horizontal row-fluid" method="post" action="prosestambahbarang.htm">
                                        <div class="control-group">
                                            <label class="control-label" for="basicinput">Barang</label>
                                            <div class="controls">
                                                <input type="text" name="barang" id="basicinput" class="span8", required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="stock" id="basicinput" class="span8" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" name="harga" id="basicinput" class="span8" required>
                                            </div>
                                        </div>
